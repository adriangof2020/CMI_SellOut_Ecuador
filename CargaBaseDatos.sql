...
SELECT F.DES_MES MES, CONVERT(VARCHAR(20), A.Fecha,103) DIA
--PROBAR SI ESE CONVERT O TRY_CPONVERT DESPUES DE REALIZAR LA CONVERSION ME 
--MANTIENE EL TIPO DE DATO AL QUE LO CONVERTI SI ES EN LA MISMA TABLA
-- Y TAMBIEN SI ES EN OTRA TABLA NUEVA COMO ES EN ESTE CASO
