...
--DELETE FROM BASE_MOBILVENDOR_AUTOMATICA_1 WHERE Agencia IN ('1000029778')
...
DELETE FROM PLAN_PANALES_1 WHERE RIGHT(Fecha,7) = '07/2022';
...
DELETE FROM PLAN_2MAYA_1 WHERE RIGHT(Fecha,7) = '07/2022';
